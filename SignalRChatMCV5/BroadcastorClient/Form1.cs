...
namespace BroadcastorClient
{
    public partial class Form1 : Form
    {
        ...
        public class BroadcastorCallback : ServiceReferenceBroad.IBroadcastorServiceCallback
        {
            ...
            public void BroadcastToClient(ServiceReferenceBroad.EventDataType eventData)
            {
        ...
        public void HandleBroadcast(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    var eventData = (ServiceReferenceBroad.EventDataType)sender;
        ...
        private ServiceReferenceBroad.BroadcastorServiceClient _client;
        ...
        private void RegisterClient()
        {
            ...
            this._client =
                new ServiceReferenceBroad.BroadcastorServiceClient(context);
        ...
        private void btnSendEvent_Click(object sender, EventArgs e)
        {
            ...
            this._client.NotifyServer(
                new ServiceReferenceBroad.EventDataType()
                {
